...
<div class="vane360-wrap index-wrap">
    ...
    <article class="m-slide m-slide-main">
        <section class="m-slide-cont">
            <ul>
                <li> <a class="m-slide-cont-fullPic" href="#"><img src="images/temp/pic_960x360_00.jpg" alt="pic_980x400_01"></a> </li>
                <li> <a class="m-slide-cont-fullPic" href="#"><img src="images/temp/pic_960x360_01.jpg" alt="pic_980x400_02"></a> </li>
            </ul>
        </section>
